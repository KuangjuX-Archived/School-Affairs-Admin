    ...
    <div>
        ...
        <div id="message-box">
            <v-card-title class="message-toggle card">
                <v-btn-toggle>
                    <v-btn id="unsolvedButton" class="tab-btn" @click="isSolvedPage = false"
                        >待处理</v-btn
                    >
                    <v-btn id="solvedButton" class="tab-btn" @click="isSolvedPage = true"
                        >已回复</v-btn
                    >
                </v-btn-toggle>
                <el-input
    ...
    created() {
        ...
        getUnsolvedQuestions(data).then((res) => {
            ...
            if (response.ErrorCode === 1) {
                ...
                this.unsolvedQuestions = response.data.data;
                this.unsolvedQuestionsPage = Math.ceil(
                ...
                getSolvedQuestions(data).then((res) => {
                    ...
                    if (response.ErrorCode === 1) {
                        ...
                        this.solvedQuestions = response.data.data;
                        this.solvedQuestionPage = Math.ceil(
                            response.data.total / 10
                        );
                        ...
                        for (
                            let i = 0;
                            i < this.unsolvedQuestions.length;
                            i++
                        ) {
