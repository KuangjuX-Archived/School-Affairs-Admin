<template>
  <div>
    <svg
      @click="openAnswer(currentQuestion.id)"
      t="1600439847025"
      class="icon"
    ...
    >
      <path
        d="M927.5 928.4H98c-16.6 0-30-13.4-30-30s13.4-30 30-30h829.5c16.6 0 30 13.4 30 30s-13.4 30-30 30zM723.9 401.4c-14.3 0-26.9-10.2-29.5-24.7-6.6-37.2-38.8-64.3-76.6-64.6l-43.6-0.3c-16.6-0.1-29.9-13.6-29.8-30.2 0.1-16.5 13.5-29.8 30-29.8h0.2l43.6 0.3c66.7 0.4 123.6 48.3 135.3 114 2.9 16.3-8 31.9-24.3 34.8-1.8 0.4-3.5 0.5-5.3 0.5z"
        fill="#F0C900"
        p-id="4865"
      ></path>
      <path
        d="M203 918.8h-4.3l-22.5-0.3-6-21.7c-23.9-87.1-4.3-181.1 52.6-251.3l412.1-509.3c22.7-28 54.9-45.9 90.7-50.3 35.8-4.4 71.4 5.2 100.2 26.9 57.8 43.6 69.3 126.1 25.7 183.9-0.9 1.2-1.8 2.4-2.7 3.5l-409.4 506c-28.8 35.6-65.9 64.6-107.3 84-40.3 18.7-84.8 28.6-129.1 28.6z m539.5-774.1c-3.2 0-6.4 0.2-9.6 0.6-20.3 2.5-38.5 12.6-51.4 28.5L269.4 683.1c-39.8 49.1-56.4 113.1-46.3 174.8 28.8-2.4 57.3-9.9 83.4-22.2 33.3-15.6 63-38.9 86.1-67.4l409.4-506c0.5-0.6 1-1.3 1.5-1.9 23.7-31.4 17.4-76.1-14-99.8-13.6-10.4-30-15.9-47-15.9z"
        fill="#3A3933"
        p-id="4866"
      ></path>
    </svg>
